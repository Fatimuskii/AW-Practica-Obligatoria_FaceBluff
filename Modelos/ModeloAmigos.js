...
class ModeloAmigos {
    ...
    // Devuelve los datos relevantes de un usuario
    buscarAmistad(id_usuario, callback){

        this.pool.getConnection(function(err,connection){

            if(err){
                callback(new Error("Error en la conexión de base de datos"), null);
            }else{
                ...
                connection.query(
                    ...
                    function (err, result) {
                        ...
                        if (err) {
                            callback(new Error("Error al extraer el usuario "+ id_usuario), null);
                        } else {
                            let usuario = null;
